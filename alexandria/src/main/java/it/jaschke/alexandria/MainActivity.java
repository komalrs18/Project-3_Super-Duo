...
public class MainActivity extends ActionBarActivity implements NavigationDrawerFragment.NavigationDrawerCallbacks, Callback {
    ...
    public static final String FRAGMENT_LIST_OF_BOOKS = "FRAGMENT_LIST_OF_BOOKS";
    public static final String FRAGMENT_ADD_BOOK = "FRAGMENT_ADD_BOOK";
    public static final String FRAGMENT_ABOUT = "FRAGMENT_ABOUT";

    final private int ACTIVITY_RESULT_CODE = 1;
